    ...
    if (this.props.location.pathname === "/privacy-policy") {
      return (
        <div className="privacyTxt">
          ...
          <p>
            {" "}
            johntzan built the Fut Stats app as a Free app. This SERVICE is
            provided by johntzan at no cost and is intended for use as is.
          </p>{" "}
          <p>
          ...
          <p>
            ...
            our Terms and Conditions, which is accessible at Fut Stats unless
    ...
    return (
      <div className="privacyTxt">
        ...
        <p>
          ...
          related to it, still belong to johntzan.
        </p>{" "}
        <p>
          johntzan is committed to ensuring that the app is as useful and
        ...
        <p>
          The Fut Stats app stores and processes personal data that you have
          ...
          Fut Stats app won’t work properly or at all.{" "}
        </p>{" "}
        <p>
          You should be aware that there are certain things that johntzan will
          ...
          Wi-Fi, or provided by your mobile network provider, but johntzan
        ...
        <p>
          Along the same lines, johntzan cannot always take responsibility for
          ...
          avail the Service, johntzan cannot accept responsibility.
        </p>{" "}
        <p>
          With respect to johntzan’s responsibility for your use of the app,
          ...
          that we can make it available to you. johntzan accepts no liability
        ...
        <p>
          ...
          keep using the app. johntzan does not promise that it will always
